...
def extract_historical_weather(city: dict, start_date: str, end_date: str):
    params = {
...
def save_historical_weather_data(df: pd.DataFrame, city_name: str, missing_date: str):
...
def run_missing_days(**kwargs):  # Fix: **kwargs para compatibilidade com Airflow
